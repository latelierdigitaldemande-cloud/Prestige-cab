                ...
                <div className="space-y-4 text-xs font-light tracking-wide text-white/90">
                  ...
                  <div className="mt-6 p-4 rounded-xl bg-white/[0.02] border border-white/5">
                    <p className="text-[10px] text-text-subtle font-light leading-relaxed">
                      {lang === 'fr' 
                        ? '💡 Les tarifs de Luxura Chauffeur sont fixes, sans surprise et incluent l\'accueil personnalisé en gare/aéroport avec pancarte.'
                        : '💡 Luxura Chauffeur offers flat, clear rates including professional airport/station welcome with meet-and-greet nameplate.'}
                    </p>
                  </div>
                </div>
              )}
